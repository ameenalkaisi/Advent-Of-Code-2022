...
impl Monkey {
    pub fn inspect_and_get_monkey_order(&mut self) -> Vec<ThrownItem> {
        ...
        for i in starting_items.iter_mut() {
            ...
            *i /= 3;
            ...
            thrown_items.push(ThrownItem { monkey_index: self.which_monkey(*i), item: *i });
        }
...
fn simulate_round(monkeys: &mut Vec<Monkey>) {
    for i in 0..monkeys.len() {
        ...
        let thrown_monkeys = cur_monkey.inspect_and_get_monkey_order();
